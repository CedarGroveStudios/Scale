...
class Labels(displayio.Group):
    def __init__(self, display=None):
        ...
        if display:
            ...
            raise RuntimeError("*** ERROR: No display specified.")
        ...
        self.chan_1_label.anchored_position = display.screen_to_rect(0.28, 0.38)
        ...
        self.chan_2_label.anchored_position = display.screen_to_rect(0.97, 0.38)
        ...
        self.chan_1_value.anchored_position = display.screen_to_rect(0.28, 0.38)
        ...
        self.chan_2_value.anchored_position = display.screen_to_rect(0.97, 0.38)
        ...
        self.tare_1_value.anchored_position = display.screen_to_rect(0.28, 0.56)
        ...
        self.tare_2_value.anchored_position = display.screen_to_rect(0.75, 0.56)
        ...
        self.alarm_1_value.anchored_position = display.screen_to_rect(0.28, 0.75)
        ...
        self.alarm_2_value.anchored_position = display.screen_to_rect(0.75, 0.75)
        ...
        self.status_label.anchored_position = display.screen_to_rect(0.50, 0.92)
        self._labels_group.append(self.status_label)

        x0, y0 = display.screen_to_rect(0.05, 0.95)
        w, h = display.screen_to_rect(0.025, 0.025)
